...
station='43413'
#fin='/Users/dmelgar/Chiapas2017/tsunami/smn/'+station+'.dat'
#fout='/Users/dmelgar/Chiapas2017/tsunami/smn/'+station+'.sac'
#fin='/Users/dmelgar/Chiapas2017/tsunami/ioc/'+station+'.txt'
#fout='/Users/dmelgar/Chiapas2017/tsunami/ioc/'+station+'.sac'
fin='/Users/dmelgar/Chiapas2017/tsunami/dart/'+station+'.txt'
fout='/Users/dmelgar/Chiapas2017/tsunami/dart/'+station+'.sac'
plot_out='/Users/dmelgar/Chiapas2017/tsunami/plots/'+station+'.pdf'
time_epi=UTCDateTime('2017-09-08T04:49:21')
tcut=timedelta(seconds=2*3600)
tprior=timedelta(seconds=1*3600)
spike_threshold=0.3
fcorner=[1./7200,1./121]
ttrim=6000
...
t1=UTCDateTime(time[-1,0]+time[-1,1])
...
#Zero out seismic portion
i=where(st[0].times()<ttrim)[0]
st[0].data[i]=0
