...
plot_out='/Users/dmelgar/Chiapas2017/tsunami/plots/'+station+'_super_long.pdf'
time_epi=UTCDateTime('2017-09-08T04:49:21')
tcut=timedelta(seconds=10*24*3600)
tprior=timedelta(seconds=24*3600)
spike_threshold=5.0
fcorner=1./14400
...
f=interp1d(t,data,kind='nearest')
data_in=f(t_in)
#Processing
...
plt.plot((st[0].times()-tprior.total_seconds())/3600,st[0].data)
plt.grid()
plt.ylim([-1.5,1.5])
