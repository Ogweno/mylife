...
srtm_file=u'/Users/dmelgar/DEMs/maule/maule_long.grd'
fout=u'/Users/dmelgar/Maule2010/tsunami/maule_30_long_coast_fg.txt'
cliplat=[-46,-26]
...
iout=where((lat_out>cliplat[0]) & (lat_out<cliplat[1]))[0]
lon_out=lon_out[iout]
lat_out=lat_out[iout]
