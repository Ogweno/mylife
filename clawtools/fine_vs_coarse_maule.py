...
static=plt.plot(eta,lat,lw=0.8,c='#6666FF',zorder=3,label='Fine')
kinematic=plt.plot(eta2,lat2,lw=1.0,c='k',zorder=4,label='Coarse')
#kinematic=plt.plot(abs(eta2[i]-eta[i]),lat[i],lw=0.5,c='r',zorder=4,label='Difference')
plt.legend(loc='upper center', bbox_to_anchor=(0.67, 0.23),ncol=1, fancybox=True, shadow=True)
xfill=array([0,0.3])
