...
fout='/Users/dmelgar/NewZealand2016/tsunami/sac/'+station+'.sac'
plot_out='/Users/dmelgar/NewZealand2016/tsunami/plots/'+station+'.pdf'
time_epi=UTCDateTime('2016-11-13T11:02:56')
tcut=timedelta(seconds=6*3600)
tprior=timedelta(seconds=0*3600)
spike_threshold=0.3
