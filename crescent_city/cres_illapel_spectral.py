...
st=read('/Users/dmelgar/tidegauge_noise/crescent_city/cres_09_2015.sac')
vmin=0
vmax=2
sealim=0.3
specmax=20
...
t1=UTCDateTime('2015-09-16T22:00:00')
t2=UTCDateTime('2015-09-18T22:00:00')
...
ax.plot(period,psd,lw=1,c='#303030',label='Illapel tsunami')
ax.plot(period_interp,2.5*psd_median,lw=1,c='#FF4500',label='10 x Noise')
ax.legend()
