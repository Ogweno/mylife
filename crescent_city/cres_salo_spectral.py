...
st=read('/Users/dmelgar/tidegauge_noise/crescent_city/cres_0910_2009.sac')
vmin=0
vmax=2
sealim=0.3
specmax=13
...
t1=UTCDateTime('2009-09-29T12:00:00')
t2=UTCDateTime('2009-10-01T00:00:00')
...
ax.plot(period,psd,lw=1,c='#303030',label='Samoa tsunami')
