...
st=read('/Users/dmelgar/tidegauge_noise/crescent_city/cres_11_2006.sac')
vmin=0
vmax=2
sealim=1.0
specmax=25
...
t1=UTCDateTime('2006-11-15T12:00:00')
t2=UTCDateTime('2006-11-17T12:00:00')
...
ax.plot(period_interp,10*psd_median,lw=1,c='#FF4500',label='10 x Noise')
ax.legend()
