...
st=read('/Users/dmelgar/tidegauge_noise/crescent_city/cres_0203_2010.sac')
vmin=0
vmax=2
sealim=0.6
specmax=50
...
t1=UTCDateTime('2010-02-27T06:00:00')
t2=UTCDateTime('2010-03-01T06:00:00')
...
ax.plot(period,psd,lw=1,c='#303030',label='Maule tsunami')
ax.plot(period_interp,9*psd_median,lw=1,c='#FF4500',label='10 x Noise')
ax.legend()
