...
st=read('/Users/dmelgar/tidegauge_noise/crescent_city/cres_1011_2012.sac')
vmin=0
vmax=2
sealim=0.5
specmax=12
...
t1=UTCDateTime('2012-10-28T03:00:00')
t2=UTCDateTime('2012-10-29T12:00:00')
...
ax.plot(period,psd,lw=1,c='#303030',label='Haida-Gwai tsunami')
ax.plot(period_interp,3*psd_median,lw=1,c='#FF4500',label='10 x Noise')
ax.legend()
