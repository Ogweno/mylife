...
fraction_keep=0.8
iter=200
reg_spatial=0.033598182862837812

home='/Users/dmelgar/Slip_inv/'
project_name='Melinka_3D'
run_name='jacknife'

model_name='maule.mod'   #Velocity model
fault_name='melinka3D.fault'    #Fault geometry
GF_list='gps_sm_insar.gflist'
tgf_file=None#'seafloor.sta'
G_name='gps_sm_insar'#'review_3.2_low' #Either name of GF matrix to load or name to save GF matrix with
...
epicenter=np.array([-73.951,-43.416,32.5])
...
nstrike=365 ; ndip=1 ; nfaults=(nstrike,ndip) #set nstrike to total no. of faults and ndip to 1 if using Tikh
