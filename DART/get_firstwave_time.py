...
profiles=glob('/Users/dmelgar/DART_analysis/bathy_profiles/*.profile.txt')
fout='/Users/dmelgar/DART_analysis/first_wave_ends.txt'
...
for k in range(len(profiles)):
    ...
    if len(i)>2:
        ...
        ttotal=t.sum()
        out[k,0:2]=prof[0,0:2]
        out[k,2]=ttotal/60
    else:
        out[k,0:2]=prof[0,1:3]
        out[k,2]=nan
