...
path=u'/Users/dmelgar/Slip_inv/Lefkada65/output/inverse_models/models/'
models=['gps_sm_5win_vr1.8.0000',
    'gps_sm_5win_vr2.0.0000',
    'gps_sm_5win_vr2.2.0000',
    'gps_sm_5win_vr2.4.0000',
    'gps_sm_5win_vr2.6.0000',
    'gps_sm_5win_vr2.8.0000',
    'gps_sm_5win_vr3.0.0000',
    'gps_sm_5win_vr3.2.0000',
    'gps_sm_5win_vr3.4.0000']
...
vr=[1.8,2.0,2.2,2.4,2.6,2.8,3.0,3.2,3.4]
...
plt.scatter(vr,vr_vel+35,marker='+',s=100,lw=1.5,c='k')
#plt.scatter(vr,vr_tsun+25,marker='+',s=100,lw=1.5,c='k')#
#plt.scatter(vr,vr_insar-10,marker='+',s=100,lw=1.5,c='k')
