...
path='/Users/dmelgar/Lefkada2015/GPS/'
gps_files=glob(path+'raw/difkin*')
time_epi=UTCDateTime('2015-11-17T07:10:07')
epicenter=array([20.6002,38.6655,10.7])  
...
if gps2sac:
    stanames=genfromtxt('/Users/dmelgar/Lefkada2015/station_info/gps.sta',usecols=0,dtype='S')
    coords=genfromtxt('/Users/dmelgar/Lefkada2015/station_info/gps.sta',usecols=[1,2])
        ...
        if len(gap_positions)>0:  #There are gaps
            for i in range(len(gap_positions)):
                if i==0:        
                    ...
                    #What is first epoch?
                    time=UTCDateTime('2015-11-17T00:00:00')+timedelta(seconds=t[0])-timedelta(seconds=17) #Apply GPS->UTC leapseconds
                    #Apply start time
