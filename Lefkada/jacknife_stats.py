...
for k in range(iter):
    ...
    gmttools.make_total_model(u'/Users/dmelgar/Slip_inv/Lefkada65/output/inverse_models/models/jacknife.'+kread+'.inv',0)
    m=genfromtxt(u'/Users/dmelgar/Slip_inv/Lefkada65/output/inverse_models/models/jacknife.'+kread+'.inv.total')
