...
gmsh_out=u'/Users/dmelgar/Chiapas2017/slab/chiapas.gmsh'

#Depth filter
maxdepth=-70
#Line filters
[L1x1 , L1y1] = [360-96.147135,  14.995028]
[L1x2 , L1y2] = [360-95.716353,  16.506242]
[L2x1 , L2y1] =[360-93.293293,  13.162869]
[L2x2 , L2y2] =[360-92.157061,  14.865960]


#Contours files 
contour_files= glob('/Users/dmelgar/Slab_Models/Mexico/*.contour')
#read fault
f=genfromtxt('/Users/dmelgar/Slab_Models/Mexico/mex_slab1.0_clip.xyz')
#Read top limit
top=genfromtxt('/Users/dmelgar/Slab_Models/Mexico/mex_top.in')
...
#Write gmsh file
xyz2gmsh(gmsh_out,contours[:,0],contours[:,1],contours[:,2],coord_type='UTM',projection_zone='15P')
