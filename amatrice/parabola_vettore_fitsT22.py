...
gmsh_out=u'/Users/dmelgar/Amatrice2016/3D_fault/_listric_T22/vettore_listric_T22.gmsh'
max_depth=-110
azimuth=155-90
...
p7=[21.8,-9.57]
p8=[19.11,-10.39]
x=array([p1[0],p2[0],p3[0],p4[0],p5[0],p6[0],p7[0],p8[0]])
y=array([p1[1],p2[1],p3[1],p4[1],p5[1],p6[1],p7[1],p8[1]])
xi=x
yi=y
