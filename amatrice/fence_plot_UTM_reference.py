...
def make_subplot(ax1,sub_corners,sub_slip,af,azimuth,elevation,title,colorbar,triangles=True,axison=False,xl=[],yl=[],axisequal=False,color='b'):
...
if faults_to_plot==5:
    make_subplot(ax,corners_detach,slip_detach,af,color='#DC143C',azimuth=-60,elevation=51,title='',colorbar=False,triangles=False,axison=False,xl=xl,yl=yl)
if pian==False:
    make_subplot(ax,corners[i_vettore_main],norm_slip[i_vettore_main],af,color='#0000CD',azimuth=-60,elevation=51,title='',colorbar=False,axison=False,axisequal=True,xl=xl,yl=yl)
    make_subplot(ax,corners[i_vettore_synth],norm_slip[i_vettore_synth],af,color='c',azimuth=-60,elevation=51,title='',colorbar=False,axison=False,axisequal=True,xl=xl,yl=yl)
    make_subplot(ax,corners[i_pian],norm_slip[i_pian],af,color='g',azimuth=-60,elevation=51,title='',colorbar=False,axison=False,axisequal=True,xl=xl,yl=yl)
    make_subplot(ax,corners[i_anti],norm_slip[i_anti],af,color='#FF8C00',azimuth=-60,elevation=51,title='',colorbar=False,axison=False,axisequal=True,xl=xl,yl=yl)
    print 'a',
