...
#load surface trace
surface_trace=genfromtxt(u'/Users/dmelgar/Amatrice2016/3D_fault/_listric_T22/surface_trace_long_fits_T22.txt')
gmsh_out=u'/Users/dmelgar/Amatrice2016/3D_fault/_complex/vettore_synth.gmsh'
max_depth=-110
azimuth=155-90
...
#p7=[21.8,-9.57]
#p8=[19.11,-10.39]
x=array([p1[0],p2[0],p3[0],p4[0],p5[0]])
y=array([p1[1],p2[1],p3[1],p4[1],p5[1]])
xi=x
yi=y
...
#Make gmsh file
gmsh_tools.xyz2gmsh(gmsh_out,fault[:,0],fault[:,1],fault[:,2],coord_type='UTM',projection_zone='33T',point_offset=76)