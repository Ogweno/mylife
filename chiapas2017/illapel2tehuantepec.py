...
#read entawai
f=genfromtxt('/Users/dmelgar/Slip_inv/Coquimbo_4s/output/inverse_models/models/gps_sm_tg_insar_9win_vel2.0_final2.0008.inv.total')
...
fout='/Users/dmelgar/Chiapas2017/tsunami/scenario/chiapas_illapel.rupt'
...
#Make dtopo
dtopo='/Users/dmelgar/Chiapas2017/tsunami/scenario/chiapas_illapel.dtopo'
dl=0.02
y=arange(13,17,dl)
x=arange(-97,-91,dl)
#X,Y=meshgrid(x,y)
