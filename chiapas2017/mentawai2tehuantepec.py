...
from numpy import cos,sin,array,deg2rad,zeros,argmin,c_,savetxt,arange,meshgrid,where
from mudpy import forward

#read entawai
f=genfromtxt('/Users/dmelgar/Chiapas2017/tsunami/scenario/mentawai_ffm.txt')
