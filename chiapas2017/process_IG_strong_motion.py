...
#read stations
path=u'/Users/dmelgar/Chiapas2017/strong_motion/IG/'
allfiles=glob(path+'*.HLE.sac')

path_out=u'/Users/dmelgar/Chiapas2017/strong_motion/sac/'
path_out_plot=u'/Users/dmelgar/Chiapas2017/strong_motion/plots/'
origin=UTCDateTime('2017-09-08T04:49:17')
t1=timedelta(seconds=-20)
t2=timedelta(seconds=240)

#event location
hypo=[-94.103,14.761,45]

model = TauPyModel(model="iasp91")


#Read stations file
stafile=genfromtxt('/Users/dmelgar/Chiapas2017/strong_motion/station_info/IG_stations.txt',usecols=1,dtype='S')
lons=genfromtxt('/Users/dmelgar/Chiapas2017/strong_motion/station_info/IG_stations.txt',usecols=2)
lats=genfromtxt('/Users/dmelgar/Chiapas2017/strong_motion/station_info/IG_stations.txt',usecols=3)

for ksta in range(19,len(allfiles)):
