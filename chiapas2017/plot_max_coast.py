...
path='/Users/dmelgar/Tsunamis/tehuantepec/_output/'
files=glob(path+'gauge01*')
fout='/Users/dmelgar/code/GMT/tehuantepec/max_eta.txt'
...
savetxt(fout,c_[lon,lat,max_eta],fmt='%.3f')