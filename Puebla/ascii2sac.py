...
files=glob(u'/Users/dmelgar/Puebla2017/strong_motion/II/raw/*')
path=u'/Users/dmelgar/Puebla2017/strong_motion/II/sac/'

for k in range(10,len(files)):
    with open(files[k]) as fp:
        for i, line in enumerate(fp):
            if i == 67:
                tstart=line.split()[-1]
                tstart=UTCDateTime('2017-09-19T'+tstart)
            elif i > 67:
                break
    f=open(files[k])
    lnum=0
    ...
    plt.savefig('/Users/dmelgar/Puebla2017/strong_motion/II/plots/'+sta+'.png')
    plt.close()
