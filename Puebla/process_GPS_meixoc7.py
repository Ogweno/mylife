...
path='/Users/dmelgar/Puebla2017/GPS/Mexico7/'
station_file=path+'gps_1Hz.sta'
#station_file=path+'station_info/gps5Hz.sta'
gps_files=glob(path+'0919/1Hz/difkin*')
...
if make_station_file:
    ...
    stas=genfromtxt('/Users/dmelgar/Puebla2017/GPS/Mexico7/sit.xyz',usecols=0,dtype='S')
    xyz=genfromtxt('/Users/dmelgar/Puebla2017/GPS/Mexico7/sit.xyz',usecols=[1,2,3])
...
if make_plots:
    ...
    for k in range(len(stanames)):
        ...
        try:
            ...
            plt.grid()
            plt.ylabel('Up (m)')
            plt.savefig(path+'plot1Hz/'+sta+'.png')
        except:
            print 'Error on '+sta
