...
stations=genfromtxt('/Users/dmelgar/Puebla2017/strong_motion/station_info/II_stations.txt',usecols=0,dtype='S')

for k in range(len(stations)):
    an=read(u'/Users/dmelgar/Puebla2017/strong_motion/II/sac/_withPicks/'+stations[k]+'.HNN.sac')
    ae=read(u'/Users/dmelgar/Puebla2017/strong_motion/II/sac/_withPicks/'+stations[k]+'.HNE.sac')
    az=read(u'/Users/dmelgar/Puebla2017/strong_motion/II/sac/_withPicks/'+stations[k]+'.HNZ.sac')
    p=az[0].stats['sac']['a']
    ...
    plt.savefig('/Users/dmelgar/Puebla2017/strong_motion/mudpy/_'+stations[k]+'II_disp.png')
    plt.close()
