...
dist_in_degs=3.0
fout=u'/Users/dmelgar/Cascadia_M8/pnwM8.sta'
hypocenter=[-124.0,41.3,19.84]
lonlat=genfromtxt(u'/Users/dmelgar/ShakeAlert/norcal_pnw.chanfile',usecols=[4,5])
sta=genfromtxt(u'/Users/dmelgar/ShakeAlert/norcal_pnw.chanfile',usecols=[1],dtype='S')
