...
path='/Users/dmelgar/Mentawai2010/GPS/'
gps_files=glob(path+'positions/difkin*')
time_epi=UTCDateTime('2010-10-25T14:42:22')
t0=UTCDateTime('2010-10-25T00:00:00')
epicenter=array([100.114,-3.484,20.6]) 
dt=1.0
...
if gps2sac:
    stanames=genfromtxt('/Users/dmelgar/Mentawai2010/GPS/station_info/mentawai.sta',usecols=0,dtype='S')
    coords=genfromtxt('/Users/dmelgar/Mentawai2010/GPS/station_info/mentawai.sta',usecols=[1,2])
...
if make_pgd:
    pathout='/Users/dmelgar/PGD/GPS/sac/Mentawai2010/'
